...
SELECT c.CompanyID, Name, ProductID FROM Company c, Supply s
...
SELECT CompanyID FROM Supply
WHERE ProductID = 1 AND CompanyID IN(SELECT CompanyID
									 FROM Supply
									 Where ProductID = 2)
...
SELECT CompanyID FROM Supply
WHERE ProductID = 1 AND CompanyID NOT IN(SELECT CompanyID
									 FROM Supply
									 Where ProductID = 2)
...
SELECT CompanyID, ProductID FROM Supply
ORDER BY ProductID
